...
export const UserGetMuestra = () => {
  ...
  const heading = ["Id", "Proyecto", "Especie", "Coordenadas", "Calidad", "imagen", "Comentarios", "Editar"]
  ...
  return (
    <>
        ...
        <tbody>
          ...
          {muestras.length !== 0 ? (
            muestras.muestras.map(({ project_name, id, aditional_comments, specimen,  image_specimen, ubication }, i) =>
              ...
              <tr key={i}>
                ...
                <td><button classNameName="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onClick={(e) => { handleInputChange(e); selectMuestra(e.target.value) }} name="id" defaultValue>Editar</button>
